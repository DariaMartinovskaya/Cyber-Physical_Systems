...
// // //    if (abs(accelX) > 1.0 || abs(gyroZ) > 100.0) { 
...
// // //             client.print("<p>AcX: <span id='AcX'>0</span> g</p>");
// // //             client.print("<p>AcY: <span id='AcY'>0</span> g</p>");
// // //             client.print("<p>AcZ: <span id='AcZ'>0</span> g</p>");
// // //             client.print("<p>GyX: <span id='GyX'>0</span> °/s</p>");
// // //             client.print("<p>GyY: <span id='GyY'>0</span> °/s</p>");
// // //             client.print("<p>GyZ: <span id='GyZ'>0</span> °/s</p>");
...
// //             client.print("<head>");
// //             client.print("<title>ESP32 WebServer</title>");
// //             client.print("<script src='https://cdn.jsdelivr.net/npm/chart.js'></script>");  // Подключение библиотеки Chart.js
// //             client.print("<script>");
// //             client.print("function updateData() {");
// //             client.print("fetch('/data').then(response => response.json()).then(data => {");
// //             client.print("document.getElementById('AcX').innerText = data.AcX;");
...
// //             client.print("<p>GyY: <span id='GyY'>0</span> °/s</p>");
// //             client.print("<p>GyZ: <span id='GyZ'>0</span> °/s</p>");
// //             client.print("<canvas id='myChart' width='400' height='200'></canvas>");  // Добавляем элемент для графика
// //             client.print("<script>");
...
// // Modify the sensor reading and thresholds to display friendly terms
// void check_conditions() {
//    float accelX = AcX / 16384.0; 
//    float gyroZ = GyZ / 131.0; 
...
//    if (abs(accelX) > 1.0 || abs(gyroZ) > 100.0) { 
//       digitalWrite(ledPin, HIGH); 
//       Serial.println("Warning: Abnormal motion detected!"); 
//       // Display friendly message on the web interface
//       send_alert("Warning: High tilt detected!");
//    } else { 
//       digitalWrite(ledPin, LOW); 
//       Serial.println("Stable condition detected.");
//    }
// }

// // Handle the client request with user-friendly display
// void handle_client() {
//     WiFiClient client = server.available();
//     if (client) {
//         String request = "";
...
//             client.print("Connection: close\r\n\r\n");
//             client.print("{");
//             client.print("\"Tilt\": \"" + String(AcX / 16384.0) + "\","); // Change to tilt-friendly
//             client.print("\"Stability\": \"" + String(GyZ / 131.0) + "\"");
//             client.print("}");
//         } else {
//             client.print("HTTP/1.1 200 OK\r\n");
//             client.print("Content-Type: text/html; charset=UTF-8\r\n");  
...
//             client.print("<!DOCTYPE HTML><html>");
//             client.print("<head>");
//             client.print("<title>ESP32 Motion Tracker</title>");
//             client.print("<script src='https://cdn.jsdelivr.net/npm/chart.js'></script>");
//             client.print("<script>");
//             client.print("function updateData() {");
//             client.print("fetch('/data').then(response => response.json()).then(data => {");
//             client.print("document.getElementById('Tilt').innerText = data.Tilt;");
//             client.print("document.getElementById('Stability').innerText = data.Stability;");
//             client.print("});");
//             client.print("}");
//             client.print("setInterval(updateData, 1000);");
//             client.print("</script>");
//             client.print("</head><body>");
//             client.print("<h1>ESP32 Motorcycle Tracker</h1>");
//             client.print("<p>Tilt: <span id='Tilt'>0</span> g</p>");
//             client.print("<p>Stability: <span id='Stability'>0</span> °/s</p>");
...
//             client.print("labels: [],");
//             client.print("datasets: [{");
//             client.print("label: 'Tilt', data: [], borderColor: 'rgb(255, 99, 132)', fill: false},");
//             client.print("{label: 'Stability', data: [], borderColor: 'rgb(54, 162, 235)', fill: false}");
//             client.print("]}");
//             client.print("});");
//             client.print("function updateChart() {");
//             client.print("fetch('/data').then(response => response.json()).then(data => {");
...
//             client.print("}");
//             client.print("labels.push(new Date().toLocaleTimeString());");
//             client.print("datasets[0].data.push(data.Tilt);");
//             client.print("datasets[1].data.push(data.Stability);");
//             client.print("myChart.update();");
//             client.print("});");
//             client.print("}");
//             client.print("setInterval(updateChart, 1000);");
